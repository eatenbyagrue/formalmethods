...
to init-patch
  ;; Init patches by randomly assigning a discretized opinion
  set opinion random resolution-of-opinions
  ;; Assign colors based on opinion
  set pcolor color-from-opinion opinion
end

to-report color-from-opinion [popinion]
  ;; Translates the opinion-value to a color
  report scale-color blue popinion 0 (resolution-of-opinions - 1)
end

to-report moore-opinion [ppatch]
  ;; Reports the mean of the opinions of the Moore-neighborhood of @ppatch
...
to go
  ...
  ;; If nothing changes, assume convergence
...
376
357
frequency distribution of opinions
NIL
NIL
0.0
10.0
...
"" ""
PENS
"pen-0" 1.0 1 -13791810 true "set-plot-x-range 0 resolution-of-opinions\nset-histogram-num-bars resolution-of-opinions" "histogram [opinion] of patches "
